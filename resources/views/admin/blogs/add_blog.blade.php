            ...
            <div class="panel-body">
                <div class="position-center">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="post_title" class="form-control" id="post_title" required  placeholder="Tiêu đề bài viết">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="post_description" id=""  required placeholder="Mô tả sản phẩm"></textarea> 
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Nội dung </label>
                        <textarea class="form-control" name="post_content" id="ckeditor"  required placeholder="Nội dung bài viêt"></textarea> 
                    </div>
                    <div class="form-group">
